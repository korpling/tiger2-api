...
public class LoadStoreTest extends XMLTestCase {
	...
	public void testLoadStore_1() throws IOException, SAXException {
		...
		// System.out.println("num of graphs: "+
		// corpus.getSegments().get(0).getGraphs().size());
		// System.out.println("num of syn nodes: "+
		// corpus.getSegments().get(0).getGraphs().get(0).getSyntacticNodes().size());
		// System.out.println("num of non-terminals: "+
		// corpus.getSegments().get(0).getGraphs().get(0).getNonTerminals().size());
		// System.out.println("num of terminals: "+
		// corpus.getSegments().get(0).getGraphs().get(0).getTerminals().size());
		// System.out.println("num of edges: "+
		// corpus.getSegments().get(0).getGraphs().get(0).getEdges().size());
