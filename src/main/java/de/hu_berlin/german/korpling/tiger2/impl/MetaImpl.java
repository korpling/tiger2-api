 ...
 * <ul>
 *   <li>{@link de.hu_berlin.german.korpling.tiger2.impl.MetaImpl#getId <em>Id</em>}</li>
 *   <li>{@link de.hu_berlin.german.korpling.tiger2.impl.MetaImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link de.hu_berlin.german.korpling.tiger2.impl.MetaImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.hu_berlin.german.korpling.tiger2.impl.MetaImpl#getDate <em>Date</em>}</li>
 *   <li>{@link de.hu_berlin.german.korpling.tiger2.impl.MetaImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link de.hu_berlin.german.korpling.tiger2.impl.MetaImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link de.hu_berlin.german.korpling.tiger2.impl.MetaImpl#getHistory <em>History</em>}</li>
 *   <li>{@link de.hu_berlin.german.korpling.tiger2.impl.MetaImpl#getCorpus <em>Corpus</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MetaImpl extends EObjectImpl implements Meta {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tiger2Package.META__DESCRIPTION, oldDescription, description));
	}
	...
	public Corpus getCorpus() {
		if (eContainerFeatureID() != Tiger2Package.META__CORPUS) return null;
	...
	public void setCorpus(Corpus newCorpus) {
		if (newCorpus != eInternalContainer() || (eContainerFeatureID() != Tiger2Package.META__CORPUS && newCorpus != null)) {
