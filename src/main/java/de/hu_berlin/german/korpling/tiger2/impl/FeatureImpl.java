 ...
 * <ul>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.FeatureImpl#getFeatureValues
 * <em>Feature Values</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.FeatureImpl#getCorpus
 * <em>Corpus</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.FeatureImpl#getId
 * <em>Id</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.FeatureImpl#getDomain
 * <em>Domain</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.FeatureImpl#getName
 * <em>Name</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.FeatureImpl#getDcrReference
 * <em>Dcr Reference</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.FeatureImpl#getType
 * <em>Type</em>}</li>
 * </ul>
 * </p>
 *
...
public class FeatureImpl extends EObjectImpl implements Feature {
	/**
	 * The cached value of the '{@link #getFeatureValues() <em>Feature
	 * Values</em>}' containment reference list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The default value of the '{@link #getDcrReference() <em>Dcr
	 * Reference</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getDcrReference()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getDcrReference() <em>Dcr
	 * Reference</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getDcrReference()
	 * @generated
	...
	/**
	 * Creates an object of type {@link FeatureValue} and initializes all
	 * internal fields.
	 */
	...
	/**
	 * Stores a map containing the value of a {@link FeatureValue} and the
	 * corresponding {@link FeatureValue} object.
	 */
				...
				case Notification.ADD: {
					...
					if (featureValue == null)
						throw new TigerInvalidModelException(
								"Cannot add the given featureValue to map, because it is null.");
					if (featureValue.getValue() == null)
						throw new TigerInvalidModelException(
								"Cannot add the given featureValue to map, because its value is null.");
					if (featureValueValue2FeatureValue == null)
						throw new TigerInternalException(
								"Cannot add featureValue to map, because the map has not been initialized.");
	...
	public EList<FeatureValue> getFeatureValues() {
		if (featureValues == null) {
			featureValues = new EObjectContainmentWithInverseEList<FeatureValue>(FeatureValue.class, this,
					Tiger2Package.FEATURE__FEATURE_VALUES, Tiger2Package.FEATURE_VALUE__FEATURE);
		}
	...
	public Corpus getCorpus() {
		if (eContainerFeatureID() != Tiger2Package.FEATURE__CORPUS)
			return null;
	...
	public void setCorpus(Corpus newCorpus) {
		if (newCorpus != eInternalContainer()
				|| (eContainerFeatureID() != Tiger2Package.FEATURE__CORPUS && newCorpus != null)) {
			...
			if (newCorpus != null)
				msgs = ((InternalEObject) newCorpus).eInverseAdd(this, Tiger2Package.CORPUS__FEATURES, Corpus.class,
						msgs);
	...
	public void setDcrReference(URI newDcrReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tiger2Package.FEATURE__DCR_REFERENCE, oldDcrReference,
					dcrReference));
	}
