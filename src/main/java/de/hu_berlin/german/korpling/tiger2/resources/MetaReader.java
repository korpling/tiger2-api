...
/**
 * Reads data from an xml file which is conform to http://korpling.german.hu-berlin.de/tiger2/V2.0.5/Meta.xsd and imports
 * the contained information into the given {@link Meta} object.
