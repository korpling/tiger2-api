...
public class Tiger2Sample {
	/**
	 * Checks the mapping of a corpus given in <tiger2/> model to a given Salt
	 * model. Containing one {@link Segment}, containing one {@link Graph},
	 * containing {@link Terminal} objects, {@link NonTerminal} objects,
	 * {@link Edge} objects between {@link Terminal}s (anaphoric) and between
	 * {@link NonTerminal}s and {@link Terminal}s (prim).
	 */
