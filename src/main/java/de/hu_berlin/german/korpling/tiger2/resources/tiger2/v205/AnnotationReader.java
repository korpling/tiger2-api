...
public class AnnotationReader extends DefaultHandler2
{
            					...
            					Attributes attributes) throws SAXException
    {
		if (Tiger2Dictionary.ELEMENT_FEATURE.equals(qName))
		{
			...
			else throw new TigerImplausibleContentException("An element of type '"+Tiger2Dictionary.ELEMENT_FEATURE+"' was found, which is not nedted in a '"+Tiger2Dictionary.ELEMENT_ANNOTATION+"' element");
		}
		else if (Tiger2Dictionary.ELEMENT_VALUE.equals(qName))
		{
			...
			else throw new TigerImplausibleContentException("An element of type '"+Tiger2Dictionary.ELEMENT_VALUE+"' was found, which is not nedted in a '"+Tiger2Dictionary.ELEMENT_FEATURE+"' element"); 
		}
		else if (Tiger2Dictionary.ELEMENT_EXTERNAL.equals(qName))
		{// annotation-data are stored in an external file
			...
			if (correspFileName== null)
				throw new TigerImplausibleContentException("Cannot read annotation-data, because of the element '"+Tiger2Dictionary.ELEMENT_EXTERNAL+"' is used, but its value '"+Tiger2Dictionary.ATTRIBUTE_CORRESP+"' isn't set.");
