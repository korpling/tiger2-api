 ...
 * <ul>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.SegmentImpl#getGraphs
 * <em>Graphs</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.SegmentImpl#getCorpus
 * <em>Corpus</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.SegmentImpl#getId
 * <em>Id</em>}</li>
 * </ul>
 * </p>
 *
...
public class SegmentImpl extends EObjectImpl implements Segment {
	 ...
	 * in a list being contained by this object. To activate this method, don't
	 * forget to set the flag {@link #eNotificationRequired()} to true.
	 * <ul>
	 * <li>If a {@link Graph} object is added and has no id an id will be
	 * computed and set</li>
	 * </ul>
	 */
	@Override
			...
			if (ref.equals(Tiger2Package.Literals.SEGMENT__GRAPHS)) {
				...
				case Notification.ADD: {
					if (newValue instanceof Graph) {
						...
						if (graph.getId() == null)
							graph.setId(this.getId() + "_g" + (this.getGraphs().size() + 1));
					}
					break;
				}
				}
	...
	public EList<Graph> getGraphs() {
		if (graphs == null) {
			graphs = new EObjectContainmentWithInverseEList<Graph>(Graph.class, this, Tiger2Package.SEGMENT__GRAPHS,
					Tiger2Package.GRAPH__SEGMENT);
		}
		return graphs;
	}
	...
	public Corpus getCorpus() {
		if (eContainerFeatureID() != Tiger2Package.SEGMENT__CORPUS)
			return null;
	...
	public void setCorpus(Corpus newCorpus) {
		if (newCorpus != eInternalContainer()
				|| (eContainerFeatureID() != Tiger2Package.SEGMENT__CORPUS && newCorpus != null)) {
			...
			if (newCorpus != null)
				msgs = ((InternalEObject) newCorpus).eInverseAdd(this, Tiger2Package.CORPUS__SEGMENTS, Corpus.class,
						msgs);
