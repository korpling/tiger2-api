 ...
 * <ul>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.AnnotationImpl#getOwner
 * <em>Owner</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.AnnotationImpl#getValue
 * <em>Value</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.AnnotationImpl#getFeatureRef
 * <em>Feature Ref</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.AnnotationImpl#getFeatureValueRef
 * <em>Feature Value Ref</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.AnnotationImpl#getName
 * <em>Name</em>}</li>
 * </ul>
 * </p>
 *
...
public class AnnotationImpl extends EObjectImpl implements Annotation {
	...
	/**
	 * The cached value of the '{@link #getFeatureRef() <em>Feature Ref</em>}'
	...
	/**
	 * The cached value of the '{@link #getFeatureValueRef() <em>Feature Value
		...
		if (owner != null && owner.eIsProxy()) {
			...
			if (owner != oldOwner) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Tiger2Package.ANNOTATION__OWNER, oldOwner,
							owner));
			}
		}
		return owner;
	...
	public NotificationChain basicSetOwner(AnnotatableElement newOwner, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Tiger2Package.ANNOTATION__OWNER, oldOwner, newOwner);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setOwner(AnnotatableElement newOwner) {
		if (newOwner != owner) {
			...
			if (owner != null)
				msgs = ((InternalEObject) owner).eInverseRemove(this, Tiger2Package.ANNOTATABLE_ELEMENT__ANNOTATIONS,
						AnnotatableElement.class, msgs);
			if (newOwner != null)
				msgs = ((InternalEObject) newOwner).eInverseAdd(this, Tiger2Package.ANNOTATABLE_ELEMENT__ANNOTATIONS,
						AnnotatableElement.class, msgs);
	...
	public void setValue(String newValue) {
		if (this.getFeatureValueRef() == null) {
			...
			value = newValue;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.SET, Tiger2Package.ANNOTATION__VALUE, oldValue,
						value));
		}
	}
	...
	public Feature getFeatureRef() {
		if (featureRef != null && featureRef.eIsProxy()) {
			...
			if (featureRef != oldFeatureRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Tiger2Package.ANNOTATION__FEATURE_REF,
							oldFeatureRef, featureRef));
			}
		}
		return featureRef;
	}
	...
	public void setFeatureRef(Feature newFeatureRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tiger2Package.ANNOTATION__FEATURE_REF, oldFeatureRef,
					featureRef));
	}
			...
			if (featureValueRef != oldFeatureValueRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Tiger2Package.ANNOTATION__FEATURE_VALUE_REF, oldFeatureValueRef, featureValueRef));
			}
		}
	...
	public void setFeatureValueRef(FeatureValue newFeatureValueRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tiger2Package.ANNOTATION__FEATURE_VALUE_REF,
					oldFeatureValueRef, featureValueRef));
	}
