 ...
 * <ul>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.Corpus#getSegments
 * <em>Segments</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.Corpus#getId <em>Id</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.Corpus#getSubCorpora <em>Sub
 * Corpora</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.Corpus#getSuperCorpus
 * <em>Super Corpus</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.Corpus#getMeta
 * <em>Meta</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.Corpus#getFeatures
 * <em>Features</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Corpus extends EObject {
	 ...
	 * {@link de.hu_berlin.german.korpling.tiger2.Segment}. It is bidirectional
	 * and its opposite is
	 * '{@link de.hu_berlin.german.korpling.tiger2.Segment#getCorpus
	 * <em>Corpus</em>}'. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Returns the value of the '<em><b>Sub Corpora</b></em>' containment
	 * reference list. The list contents are of type
	 * {@link de.hu_berlin.german.korpling.tiger2.Corpus}. It is bidirectional
	 * and its opposite is
	 * '{@link de.hu_berlin.german.korpling.tiger2.Corpus#getSuperCorpus
	 * <em>Super Corpus</em>}'. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Sub Corpora</em>' containment reference list
	 * isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 * @return the value of the '<em>Sub Corpora</em>' containment reference
	 *         list.
	...
	/**
	 * Returns the value of the '<em><b>Super Corpus</b></em>' container
	 * reference. It is bidirectional and its opposite is
	 * '{@link de.hu_berlin.german.korpling.tiger2.Corpus#getSubCorpora <em>Sub
	 * Corpora</em>}'. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Super Corpus</em>' container reference isn't
	 ...
	 * Sets the value of the
	 * '{@link de.hu_berlin.german.korpling.tiger2.Corpus#getSuperCorpus
	 * <em>Super Corpus</em>}' container reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Super Corpus</em>' container
	 *            reference.
	 * @see #getSuperCorpus()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Meta</b></em>' containment reference. It
	 ...
	 * list. The list contents are of type
	 * {@link de.hu_berlin.german.korpling.tiger2.Feature}. It is bidirectional
	 * and its opposite is
	...
	/**
	 * Creates and returns a new {@link Annotation} object and refers it to the
	 * corresponding {@link Feature} and {@link FeatureValue} object matching
	 * the parameters <code>name</code> and <code>domain</code> or
	 * <code>value</code>. If the parameters <code>name</code> and
	 * <code>domain</code> are null will be returned.
	 * 
	 * @param name
	 *            name to identify the {@link Feature} object
	 * @param domain
	 *            domain to identify the {@link Feature} object
	 * @param value
	 *            value to identify the {@link FeatureValue} object
	 * @return the created {@link Annotation} object
	 * @exception throws
	 *                an {@link TigerInvalidModelException}, if no
	 *                {@link Feature} object matching the parameters was found,
	 * @model
	 * @generated
	 */
	 ...
	 * the parameters <code>name</code> and <code>domain</code> or
	 * <code>value</code>. If the parameters <code>name</code> and
	 * <code>domain</code> are empty, null will be returned. If no
	 * {@link Feature} or {@link FeatureValue} having the given coordinates was
	 * found, the search will be done again without the <code>type</code>.
	 * 
	 * @param featureName
	 *            name to identify the {@link Feature} object
	 * @param domain
	 *            domain to identify the {@link Feature} object
	 * @param type
	 *            type of the annotation corresponding to a {@link Feature}
	 * @param featureValue
	 *            value to identify the {@link FeatureValue} object
	 * @return the created {@link Annotation} object
	 * @exception throws
	...
	/**
	 * Searches a {@link Feature} object matching to the given
	 * <em>featureName</em> and <em>featureDomain</em>.
	 * 
	 * @param featureName
	 * @param domain
	...
	/**
	 * Searches a {@link FeatureValue} object matching to the given
	 * <em>featureValueValue</em> which is contained in a {@link Feature} object
	 * matching to the given <em>featureName</em> and <em>featureDomain</em>.
	 * 
	 * @param featureName
	 * @param featureDomain
