...
public interface TigerXMLDictionary {
	...
	/**
	 * Name of the element 'corpus' in the xml serialization of the TigerXML
	 * api. XPath to element in TigerXML: /corpus
	 */
	public static String ELEMENT_CORPUS = "corpus";
	/**
	 * Name of the element 'subcorpus' in the xml serialization of the TigerXML
	 * api. XPath to element in TigerXML: /corpus/body/subcorpus
	 */
	...
	/**
	 * Name of the element 'author' in the xml serialization of the TigerXML
	 * api. XPath to element in TigerXML: /corpus/head/meta/author
	 */
	 ...
	 * TigerXML api. XPath to element in TigerXML: /corpus/head/meta/description
	 */
	public static String ELEMENT_DESCRIPTION = "description";
	/**
	 * Name of the element 'format' in the xml serialization of the TigerXML
	 * api. XPath to element in TigerXML: /corpus/head/meta/format
	 */
	public static String ELEMENT_FORMAT = "format";
	/**
	 * Name of the element 'history' in the xml serialization of the TigerXML
	 * api. XPath to element in TigerXML: /corpus/head/meta/history
	 */
	public static String ELEMENT_HISTORY = "history";

	/**
	 * Name of the element 'annotation' in the xml serialization of the TigerXML
	 * api. XPath to element in TigerXML: /corpus/head/annotation
	 */
	public static String ELEMENT_ANNOTATION = "annotation";
	/**
	 * Name of the element 'feature' in the xml serialization of the TigerXML
	 * api. XPath to element in TigerXML: /corpus/head/annotation/feature
	 */
	public static String ELEMENT_FEATURE = "feature";
	/**
	 * Name of the element {@value TigerXMLDictionary#ELEMENT_EDGELABEL} in the
	 * xml serialization of the TigerXML api. XPath to element in TigerXML:
	 * /corpus/head/annotation/feature/edgelabel
	 */
	public static String ELEMENT_EDGELABEL = "edgelabel";
	/**
	 * Name of the element '{@value TigerXMLDictionary#ELEMENT_SECEDGELABEL}' in
	 * the xml serialization of the TigerXML api. XPath to element in TigerXML:
	 * /corpus/head/annotation/secedgelabel
	 */
	public static String ELEMENT_SECEDGELABEL = "secedgelabel";
	/**
	 * Name of the attribute 'name' in the xml serialization of the TigerXML
	 * api. XPath to element in TigerXML: /corpus/head/annotation/feature/@name
	 * /corpus/head/annotation/feature/value/@name
	 */
	public static String ATTRIBUTE_NAME = "name";
	/**
	 * Name of the attribute 'domain' in the xml serialization of the TigerXML
	 * api. XPath to element in TigerXML:
	 * /corpus/head/annotation/feature/@domain
	 */
	...
	/**
	 * Name of the attribute 'xml:id' in the xml serialization of the TigerXML
	 * api.
	 */
	...
	/**
	 * Name of the attribute 'root' in the xml serialization of the TigerXML
	 * api. XPath to element in TigerXML: /corpus/body/s/graph/@root
	 */
	public static String ATTRIBUTE_ROOT = "root";
	/**
	 * Name of the attribute 'discontinuous' in the xml serialization of the
	 * TigerXML api. XPath to element in TigerXML:
	 * /corpus/body/s/graph/@discontinuous
	 */
	public static String ATTRIBUTE_DISCONTINUOUS = "discontinuous";
	/**
	 * Name of the element 'terminals' in the xml serialization of the TigerXML
	 * api.
	 */
	...
	/**
	 * Name of the attribute 'word' in the xml serialization of the TigerXML
	 * api. This is not an attribute defined in the TigerXML schema, but it is
	 * common use to use this attribute to store the primary text covered by a
	 * terminal. XPath to element in TigerXML:
	 * /corpus/body/s/graph/terminals/t/@word
	 */
	public static String ATTRIBUTE_WORD = "word";
	/**
	 * Name of the attribute 'target' in the xml serialization of the TigerXML
	 * api.
	 */
	...
	/**
	 * Name of the element 'secedge' in the xml serialization of the TigerXML
	 * api.
	 */
	public static String ELEMENT_SECEDGE = "secedge";

	/**
	 * Name of the attribute 'label' used in the xml serialization of the
	 * TigerXML for edge and secedge elements.
	 */
