 ...
 * <ul>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.FeatureValueImpl#getFeature
 * <em>Feature</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.FeatureValueImpl#getId
 * <em>Id</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.FeatureValueImpl#getValue
 * <em>Value</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.FeatureValueImpl#getDescription
 * <em>Description</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.FeatureValueImpl#getDcrReference
...
public class FeatureValueImpl extends EObjectImpl implements FeatureValue {
	...
	public Feature getFeature() {
		if (eContainerFeatureID() != Tiger2Package.FEATURE_VALUE__FEATURE)
			return null;
	...
	public void setFeature(Feature newFeature) {
		if (newFeature != eInternalContainer()
				|| (eContainerFeatureID() != Tiger2Package.FEATURE_VALUE__FEATURE && newFeature != null)) {
			...
			if (newFeature != null)
				msgs = ((InternalEObject) newFeature).eInverseAdd(this, Tiger2Package.FEATURE__FEATURE_VALUES,
						Feature.class, msgs);
			msgs = basicSetFeature(newFeature, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tiger2Package.FEATURE_VALUE__FEATURE, newFeature,
					newFeature));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tiger2Package.FEATURE_VALUE__DESCRIPTION,
	...
	public void setDcrReference(URI newDcrReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tiger2Package.FEATURE_VALUE__DCR_REFERENCE,
					oldDcrReference, dcrReference));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case Tiger2Package.FEATURE_VALUE__FEATURE:
			return eInternalContainer().eInverseRemove(this, Tiger2Package.FEATURE__FEATURE_VALUES, Feature.class,
					msgs);
		}
