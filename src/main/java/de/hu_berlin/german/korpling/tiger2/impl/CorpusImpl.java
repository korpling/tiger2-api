 ...
 * <ul>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.CorpusImpl#getSegments
 * <em>Segments</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.CorpusImpl#getId
 * <em>Id</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.CorpusImpl#getSubCorpora
 * <em>Sub Corpora</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.CorpusImpl#getSuperCorpus
 * <em>Super Corpus</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.CorpusImpl#getMeta
 * <em>Meta</em>}</li>
 * <li>{@link de.hu_berlin.german.korpling.tiger2.impl.CorpusImpl#getFeatures
 * <em>Features</em>}</li>
 * </ul>
 * </p>
 *
...
public class CorpusImpl extends EObjectImpl implements Corpus {
	...
	/**
	 * The cached value of the '{@link #getSubCorpora() <em>Sub Corpora</em>}'
	 * containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getSubCorpora()
	 * @generated
	...
	/**
	 * Creates a new object of type {@link CorpusImpl} and initializes all
	 * internal fields.
	 */
	...
	/**
	 * This {@link HashMap} stores a pair of the value {@link Feature#getName()}
	 * and {@link Feature#getDomain()} and the corresponding {@link Feature}
	 * object for having a fast access. The key is created by concatenating
	 * {@link Feature#getName()} and {@link Feature#getDomain()}.
	 */
	private ConcurrentHashMap<String, Feature> featureNameDomain2FeatureMap = null;

	/**
	 * Specifies the separator to be used to separate the single items of a key
	 * of the internal hash table for finding {@link Feature} objects. Generates
	 * an identifier for {@link Segment} objects if they do not already have
	 * one.
	 */
	protected static final String FEATURE_SEPARATOR = "#";

	/**
	 * This method must be implemented and return true, if this object shall be
	 * notified, when adding objects into contained lists (Containment
	 * relation).
	 * 
	...
	/**
	 * This method is invoked by the EMF framework, when something has changed
	 * in a list being contained by this object.
	 */
	@Override
			...
			if (ref.equals(Tiger2Package.Literals.CORPUS__FEATURES)) {
				...
				case Notification.ADD_MANY:
					throw new UnsupportedOperationException(
							"Adding more than one Feature object is not supported yet.");
					// break;
				...
				case Notification.REMOVE_MANY:
					throw new UnsupportedOperationException(
							"Removing more than one Feature object is not supported yet.");
					// break;
				default:
					break;
				}
	...
	public EList<Segment> getSegments() {
		if (segments == null) {
			segments = new EObjectContainmentWithInverseEList<Segment>(Segment.class, this,
					Tiger2Package.CORPUS__SEGMENTS, Tiger2Package.SEGMENT__CORPUS);
		}
		return segments;
	}
	...
	public EList<Corpus> getSubCorpora() {
		if (subCorpora == null) {
			subCorpora = new EObjectContainmentWithInverseEList<Corpus>(Corpus.class, this,
					Tiger2Package.CORPUS__SUB_CORPORA, Tiger2Package.CORPUS__SUPER_CORPUS);
		}
		return subCorpora;
	}
	...
	public Corpus getSuperCorpus() {
		if (eContainerFeatureID() != Tiger2Package.CORPUS__SUPER_CORPUS)
			return null;
	...
	public void setSuperCorpus(Corpus newSuperCorpus) {
		if (newSuperCorpus != eInternalContainer()
				|| (eContainerFeatureID() != Tiger2Package.CORPUS__SUPER_CORPUS && newSuperCorpus != null)) {
			...
			if (newSuperCorpus != null)
				msgs = ((InternalEObject) newSuperCorpus).eInverseAdd(this, Tiger2Package.CORPUS__SUB_CORPORA,
						Corpus.class, msgs);
			msgs = basicSetSuperCorpus(newSuperCorpus, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tiger2Package.CORPUS__SUPER_CORPUS, newSuperCorpus,
					newSuperCorpus));
	}
	...
	public NotificationChain basicSetMeta(Meta newMeta, NotificationChain msgs) {
		...
		meta = newMeta;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Tiger2Package.CORPUS__META,
					oldMeta, newMeta);
			if (msgs == null)
				msgs = notification;
			else
	...
	public EList<Feature> getFeatures() {
		if (features == null) {
			features = new EObjectContainmentWithInverseEList<Feature>(Feature.class, this,
					Tiger2Package.CORPUS__FEATURES, Tiger2Package.FEATURE__CORPUS);
		}
		return features;
	}
	...
	public Annotation createAnnotation(String featureName, DOMAIN domain, String type, String featureValue) {
		...
		if ((featureName != null) && (!featureName.isEmpty()) && (domain != null)) {
			Feature feature = this.findFeature(featureName, domain, type);
			if (feature == null) {// generalized search
			...
			if (feature != null) {
				...
				if (featureValue1 == null) {// generalized search
				...
				if (featureValue1 != null) {
					...
					if ((feature2 != null) && (feature2.getFeatureValues() != null)
					...
					throw new TigerInvalidModelException("Cannot create an annotation for feature '" + featureName
							+ "' in domain '" + domain + "' and type '" + type + "' with value '" + featureValue
							+ "', because there is no featureValue defined for such an annotation value. Known values are: "
							+ features);
				}
			} else
				throw new TigerInvalidModelException("Cannot create an annotation for feature '" + featureName
						+ "' in domain '" + domain + "' with value '" + featureValue
						+ "', because there is no matching feature defined. Supported features are: "
						+ this.featureNameDomain2FeatureMap);
		}
		return (retVal);
	}
	 ...
	 */
	public FeatureValue findFeatureValue(String featureName, DOMAIN featureDomain, String type,
		...
		return (null);
		// else
		// throw new TigerInvalidModelException("Cannot find a feature-value
		// object for featureName='"+featureName+"',
		// featureDomain='"+featureDomain+"' and type='"+type+"', because no
		// feature having these coordinates exist.");
		...
		case Tiger2Package.CORPUS__META:
			if (meta != null)
				msgs = ((InternalEObject) meta).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Tiger2Package.CORPUS__META, null, msgs);
