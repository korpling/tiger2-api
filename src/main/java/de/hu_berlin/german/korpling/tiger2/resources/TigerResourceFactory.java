...
public class TigerResourceFactory extends ResourceFactoryImpl 
{
	 ...
	 * <ul>
	 *   <li>{@link TIGER2_FILE_TYPES#TIGER2} - containing an entire corpus-structure</li>
	 *   <li>{@link TIGER2_FILE_TYPES#TIGER2_SUBCORPUS} - containing a sub-corpus</li>
	 *   <li>{@link TIGER2_FILE_TYPES#TIGER2_ANNOTATION} - containing only annotation definitions</li>
	 *   <li>{@link TIGER2_FILE_TYPES#TIGER2_METADATA} - containing only meta-data</li>
	 * </ul>
	 * @author Florian Zipser
	 *
	 */
	public enum TIGER2_FILE_TYPES {TIGER2, TIGER2_SUBCORPUS, TIGER2_ANNOTATION, TIGER2_METADATA};
	...
	/**
	 * Checks the type of the <tiger2/> file, by reading its content.  A <tiger2/> file can be separated into files containing an 
	 * entire corpus-structure, containing a sub-corpus, containing only annotation definitions or containing only meta-data. 
	 * @param uri file to be checked
